...
from swarmEngine import Swarm, Unit
...
class ANFIS:
    ...
    def train(self, global_optimization: bool, learn_premises: bool, learn_operators: bool, learn_consequents: bool,
              n_iter=100, bounds_premises=None, n_units=250, exploration_iters=250):
        ...
        if learn_premises and learn_operators and learn_consequents:
            ...
            res, error = optimizer.run(n_iter, verbose=True, exploration_iters=exploration_iters)
